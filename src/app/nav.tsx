...
const LINKS = [
  ...
  { href: "/customers", label: "Customers (coming soon)", disabled: true },
  { href: "/rfqs", label: "RFQs (coming soon)", disabled: true },
  { href: "/quotations", label: "Quotations (coming soon)", disabled: true },
];
  ...
  return (
    <aside style={{ width: 220, background: "#0a1628", color: "white", padding: 20, display: "flex", flexDirection: "column" }}>
      ...
      <nav style={{ display: "flex", flexDirection: "column", gap: 8, flex: 1 }}>
        {LINKS.map((l) =>
          l.disabled ? (
            <span key={l.href} style={{ color: "#5c6b82", fontSize: 14, padding: "6px 0" }}>{l.label}</span>
          ) : (
